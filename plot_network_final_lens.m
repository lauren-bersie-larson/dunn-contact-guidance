function plot_network_final_lens(nodes, fibers, fibseg_nodes, direction, h, k, l, R, L, surface_fibs)
...
for n = 1 : num_fibers
    ...
    if ismember(n, surface_fibs)
        plot3( x, y, z, 'g' );
        hold on
    elseif ismember(fibers(n,1), fibseg_nodes) && ismember(fibers(n,2), fibseg_nodes) %&& ~ismember(n, surface_fibs)
        plot3( x, y, z, 'r' );
        hold on
    else
        plot3( x, y, z, 'b' );
